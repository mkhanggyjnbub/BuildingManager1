    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if ("signup".equals(otpPurpose)) {
                ...
                System.out.println("tk: " + tempUser.getUserName());
                System.out.println("pass: " + tempUser.getPassword());
                System.out.println("mail: " + tempUser.getEmail());
                System.out.println("dob: " + tempUser.getDateOfBirth());
                System.out.println("phone: " + tempUser.getPhone());
                System.out.println("cccd: " + tempUser.getIdentityNumber());
