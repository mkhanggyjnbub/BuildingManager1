...
public class CreateExtraCharge extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("check".equals(action)) {
            ...
            if (currentEnd == null) {
                currentEnd = currentBooking.getEndDate().atTime(12, 0); // hoặc .atStartOfDay()
            ...
            LocalDateTime maxExtendDate = (nextBooking != null)
                    ? nextBooking.getStartDate().atTime(12, 0, 0)
            ...
            if (startTime == null) {
                startTime = booking.getEndDate().atTime(12, 0); // LocalDate → LocalDateTime
            }
