...
public class ViewBookingHistory extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Bookings> bookingList = bookingDao.getBookingHistoryByCustomerId(customerId);

        // Gửi dữ liệu sang JSP
        request.setAttribute("bookings", bookingList);
        request.getRequestDispatcher("booking/viewBookingHistory.jsp").forward(request, response);
    }
