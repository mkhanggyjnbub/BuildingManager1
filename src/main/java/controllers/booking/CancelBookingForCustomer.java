...
public class CancelBookingForCustomer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int check = dao.cancelBookingById(bookingId);

            if (check > 0) {
                response.sendRedirect("ViewBookingHistory");
            } else {
                // Bạn có thể thay thành thông báo lỗi trên trang hiện tại hoặc chuyển đến error.jsp
