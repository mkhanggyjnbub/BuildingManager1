 ...
 */
package controllers.newsDetails;
...
public class NewsDetails extends HttpServlet {
    ...
    private NewDAO newsDao = new NewDAO(); // Tạo đối tượng NewsDAO
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (news != null) {
                ...
                request.getRequestDispatcher("news/newDetails.jsp").forward(request, response);
            } else {
