...
//        WebSocket.sendNotificationTo(userId, message);
        WebSocket.sendNotificationToAll("📢 Thông báo từ admin lúc: " + new Date());
        response.getWriter().write("Đã gửi!");

        request.setAttribute("success", "Gửi thành công tới user " + userId);
