<%-- 
    ...
    Created on : 3 Aug 2025, 12:14:13
    Author     : dodan
--%>
    ...
    <body>
        ...
        <div class="form-container">
            ...
            <c:if test="${not empty userInfomation}">
                <form name="updateForm" action="EditUserProfile" method="post" onsubmit="return validateForm();" enctype="multipart/form-data">
                    ...
                    <input type="date" name="dateOfBirth" id="dob"
                           value="${userInfomation.dayOfBirth}"
                           required
