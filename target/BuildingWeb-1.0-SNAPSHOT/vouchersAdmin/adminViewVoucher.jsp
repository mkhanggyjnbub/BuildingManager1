...
<body>
    <div class="voucher-details">
        ...
        <div class="detail-row"><span class="detail-label">Type ID:</span> ${voucher.typeId}</div>
        <div class="detail-row"><span class="detail-label">Discount Percent:</span> ${voucher.discountPercent}%</div>
        <div class="detail-row"><span class="detail-label">Discount Amount:</span> ${voucher.discountAmount}đ</div>
