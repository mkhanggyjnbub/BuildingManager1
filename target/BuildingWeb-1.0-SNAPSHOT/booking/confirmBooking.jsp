            ...
            <section class="section-card" aria-labelledby="room-info-title">
                ...
                <div class="room-info-grid">
                    ...
                    <div>
                        ...
                        <p class="room-info-item">
                            <span class="room-info-label">Chính sách hủy:</span>
                            <span class="room-info-value">Miễn phí trước 24h</span>
                        </p>
                    </div>
                </div>
                <div class="img">  <img 
            ...
            <section class="section-card" aria-labelledby="booking-section-title">
                ...
                <form class="form" id="bookingForm">
                    ...
                    <div
                        ...
                        <p class="summary-item">
                            Discount: 
                            <span class="summary-discount">-0 VND (%)</span>
                        </p>
                        ...
                        <p class="summary-total">
                            Total Payment: 
                            <span class="summary-totalPrice"  data-price="${room.price}" id="price3">${room.price} VND</span>
                        </p>
                    </div>
