...
<html>
    <head>
        ...
        <style>
            ...
            .spark-button {
                ...
                box-shadow: 0 4px 8px rgba(27, 42, 78, 0.1);
            }

            .spark-button:hover {
                background-color: #1b2a4e; /* xanh navy */
                color: #ffffff;
                box-shadow: 0 6px 12px rgba(27, 42, 78, 0.2);
    ...
    <body>
        <a class="spark-button" href="Dashboard">Back To Dashboard</a>
